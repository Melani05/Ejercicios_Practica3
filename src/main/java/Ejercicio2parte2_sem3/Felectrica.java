package Ejercicio2parte2_sem3;

public class Felectrica {
    ...
    public Felectrica(double Ncuenta, double lecturaAnteriorM, double lecturaActualM, double multiplicador, String consumoM, String consumoD, double valorFactura) {
